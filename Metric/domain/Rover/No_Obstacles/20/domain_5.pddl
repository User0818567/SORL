...
:effect (and (decrease (energy ?x) 0.5) 
             (increase (rover_x ?x) 0.5)
             (increase (total_time) 0.5)
             (increase (distance) 0.5)
		)
)
...
:effect (and (decrease (energy ?x) 0.5) 
             (decrease (rover_x ?x) 0.5)
             (decrease (rover_y ?x) 0.5)
             (increase (total_time) 0.5)
             (increase (distance) 0.7071068)
    )
)
