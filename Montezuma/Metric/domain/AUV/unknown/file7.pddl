...
(:init
	...
	(diagonallink x4 x6 y4 y6)
	(diagonallink x4 x6 y5 y7)
	...
	(diagonallink x6 x8 y5 y7)
	(diagonallink x6 x4 y6 y4)
	(diagonallink x6 x4 y6 y8)
	(diagonallink x6 x8 y6 y8)
	(diagonallink x6 x8 y6 y4)
	(diagonallink x6 x8 y7 y9)
	(diagonallink x6 x8 y7 y5)
	(diagonallink x6 x4 y7 y5)
