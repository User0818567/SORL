...
:effect (and (decrease (energy ?x) 0.01) 
             (increase (rover_x ?x) 0.02)
             (increase (total_time) 0.01)
             (increase (distance) 0.02)
		)
)
...
:effect (and (decrease (energy ?x) 0.01) 
             (decrease (rover_x ?x) 0.02)
             (decrease (rover_y ?x) 0.02)
             (increase (total_time) 0.01)
             (increase (distance) 0.02828427)
    )
)
