...
:effect (and (decrease (energy ?x) 0.1) 
             (increase (rover_x ?x) 0.2)
             (increase (total_time) 0.1)
             (increase (distance) 0.2)
		)
)
...
:effect (and (decrease (energy ?x) 0.1) 
             (decrease (rover_x ?x) 0.2)
             (decrease (rover_y ?x) 0.2)
             (increase (total_time) 0.1)
             (increase (distance) 0.28284271)
    )
)
