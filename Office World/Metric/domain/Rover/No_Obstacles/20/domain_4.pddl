...
:effect (and (decrease (energy ?x) 0.2) 
             (increase (rover_x ?x) 0.4)
             (increase (total_time) 0.2)
             (increase (distance) 0.4)
		)
)
...
:effect (and (decrease (energy ?x) 0.2) 
             (decrease (rover_x ?x) 0.4)
             (decrease (rover_y ?x) 0.4)
             (increase (total_time) 0.2)
             (increase (distance) 0.56568542)
    )
)
