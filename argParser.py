...
#params for sdrl
parser.add_argument("--sdrl_domain_file",type=str, default= "Metric/SDRL/domain.pddl")
parser.add_argument("--sdrl_problem_file",type=str, default="Metric/SDRL/prob.pddl")
...
parser.add_argument("--num_subgoal",type=int,default=20)
...
parser.add_argument("--explorationSteps", type=int, default=20000)
...
# params for log
parser.add_argument("--logdir", type=str, default='./new_sorldata_4')
